...
| init | Downloads (open action, not accepted debt) | Real ABN AMRO / PayPal download flows verified via mocked tests only; live-credential session still pending | 2026-07-08 | Divya + Claude |
